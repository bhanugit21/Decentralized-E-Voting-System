...
contract Voting {
   ...
   function createParty(string memory cn, string memory pn, string memory an, string memory sy, string memory aa) public {
    ...
    function getCandidateAadhar(uint i) public view returns (string memory) {
        party memory chq = partyList[i];
	return chq.aadhar;
    } 
  ...
  function createUser(string memory _username, string memory _email, string memory _password, string memory _phone, string memory _address, string memory aa) public {
      usersList[userCount] = user(_username, _email, _password, _phone, _address, aa);
    ...
    function getUserAadhar(uint i) public view returns (string memory) {
        user memory usr = usersList[i];
	return usr.aadhar;
    }
}